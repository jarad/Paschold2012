...
#' B73, Mo17, B73xMo17, and Mo17xB73. 
#' 
...
#'   \item{Mo17}{read count attributed to Mo17}
...
#' 
#' The data have been lengthed so that each sample is in a unique row with B73 and 
...
#' attributed to a particular genome, the sum of the B73 and Mo17 columns may not 
#' equal the total column, but the sum should never be greater than the B73 and Mo17
#' columns. Non-zero counts in the B73 column for the Mo17 genotype (and the reverse)
#' indicate false positive reads.
#' @references
